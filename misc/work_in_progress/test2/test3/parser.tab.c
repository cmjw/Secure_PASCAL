...
{
  "$end", "error", "$undefined", "T_INT", "T_PLUS", "T_MINUS", "T_END",
...
#line 1325 "parser.tab.c"
  ...
  case 5:
#line 38 "parser.y"
                     { (yyval.ast_node) = create_integer_node((yyvsp[0].ival)); }
#line 1331 "parser.tab.c"
    break;

  case 6:
#line 39 "parser.y"
                                    { (yyval.ast_node) = create_binary_op_node((yyvsp[-2].ast_node), (yyvsp[0].ast_node), '+'); }
